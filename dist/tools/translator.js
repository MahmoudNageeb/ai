...
(0, index_1.registerTool)({
    ...
    execute: async (input) => {
        ...
        const resp = await llm.chat([{ role: 'user', content: `Translate the following text ${src} to ${input.target_language}. Output the translation ONLY, no quotes or commentary.\n\n${text}` }], 'You are a professional translation sub-module of JARVIS. Respond with the translation only.');
        return {
